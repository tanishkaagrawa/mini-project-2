...
app.post("/addrecipe",async(req,res)=>{
    ...
    // }
    try {
        const {recipeName, imageUrl, servings, prep_time, cook_time,ingredients, instructions, notes} = req.body;

        const d3 = new addrecipe({recipeName, imageUrl, servings, prep_time, cook_time,ingredients, instructions, notes});
        await d3.save();
